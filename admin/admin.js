...
async function openAdmin(){
  ...
  try{
    ...
    $('loginStatus').textContent = 'Cannot verify password. Worker API is not deployed.';
    return;
  }
  ...
  try{
    ...
    if(!health.kvBindingFound){
      $('loginStatus').textContent = 'KV binding missing. Add CONTENT binding or use archive v41 with wrangler.toml.';
      return;
    }
